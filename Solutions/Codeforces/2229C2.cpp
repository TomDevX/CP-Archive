 ...
 *    tags: Adhoc, Math
 *    complexity: O(n)
 *    note: The best strategy is to calculate all possible areas to make numbers positive (like C1, switch elements in 1 -> i-1 to negative and sacrifice ith element to swap all of them to positive)
**/
