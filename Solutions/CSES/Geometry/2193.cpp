 ...
 *    tags: Geometry
 *    complexity: O(n)
 *    note: Use Pick's theorem. To get B in the formula, we use gcd between the distance of x and y. Notice that we don't +1 in B because it need to spare the (x2,y2) in (x1,y1) -> (x2,y2) to make (x2,y2) the start point for the next segment
**/
